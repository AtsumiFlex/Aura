 ...
 * Gateway Opcodes
 *
 * Gateway Opcodes are used to identify the type of payload.
 *
 ...
 *
 * Is a zod enum that represents the available {@link GatewayOpcodes}.
 */
 ...
 *
 * Gateway close event codes are used to identify the reason for the disconnection.
 *
...
/**
 * Gateway Close Event Codes Enum
 *
 * Is a zod enum that represents the available {@link GatewayCloseEventCodes}.
 */
 ...
 * Voice Opcodes
 *
 * Voice Opcodes are used to identify the type of payload.
 *
 ...
 * Voice Opcodes Enum
 *
 * Is a zod enum that represents the available {@link VoiceOpcodes}.
 */
 ...
 *
 * Voice close event codes are used to identify the reason for the disconnection.
 *
...
/**
 * Voice Close Event Codes Enum
 *
 * Is a zod enum that represents the available {@link VoiceCloseEventCodes}.
 */
 ...
 * HTTP Response Codes
 *
 * HTTP response codes are used to identify the status of the response.
 *
 ...
 *
 * Is a zod enum that represents the available {@link HTTPResponseCodes}.
 */
 ...
 * JSON Error Codes
 *
 * JSON error codes are used to identify the type of error.
 *
...
/**
 * JSON Error Codes Enum
 *
 * Is a zod enum that represents the available {@link JSONErrorCodes}.
 */
 ...
 * JSON Error Response
 *
 * JSON error response is used to identify the type of error.
 *
...
/**
 * JSON Error Response Infer
 *
 * The inferred type of {@link JSONErrorResponse}
 */
 ...
 * RPC Error Codes
 *
 * RPC error codes are used to identify the type of error.
 *
...
/**
 * RPC Error Codes Enum
 *
 * Is a zod enum that represents the available {@link RPCErrorCodes}.
 */
 ...
 *
 * RPC close event codes are used to identify the reason for the disconnection.
 *
...
/**
 * RPC Close Event Codes Enum
 *
 * Is a zod enum that represents the available {@link RPCCloseEventCodes}.
 */
