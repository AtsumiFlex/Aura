...
/**
 * Zod schema for validating {@link GatewayOpcodes}.
 *
 * @example
 * GatewayOpcodesEnum.parse(GatewayOpcodes.Dispatch); // Valid
 * GatewayOpcodesEnum.parse(12); // Throws an error
 */
...
/**
 * Zod schema for validating {@link GatewayCloseCodes}.
 *
 * @example
 * GatewayCloseCodesEnum.parse(GatewayCloseCodes.UnknownError); // Valid
 * GatewayCloseCodesEnum.parse(4015); // Throws an error
 */
...
/**
 * Zod schema for validating {@link VoiceOpcodes}.
 *
 * @example
 * VoiceOpcodesEnum.parse(VoiceOpcodes.Identify); // Valid
 * VoiceOpcodesEnum.parse(14); // Throws an error
 */
...
/**
 * Zod schema for validating {@link VoiceCloseCodes}.
 *
 * @example
 * VoiceCloseCodesEnum.parse(VoiceCloseCodes.UnknownOpcode); // Valid
 * VoiceCloseCodesEnum.parse(4017); // Throws an error
 */
...
/**
 * Zod schema for validating {@link RestResponses}.
 *
 * @example
 * RestResponsesEnum.parse(RestResponses.Ok); // Valid
 * RestResponsesEnum.parse(503); // Throws an error
 */
export const RestResponsesEnum = z.nativeEnum(RestResponses);
...
export enum JSONErrorCodes {
	 ...
	 */
	MaximumNumberOfGuildsReached100 = 30_001,
	/**
	 * Maximum number of friends reached (1000)
	 */
	MaximumNumberOfFriendsReached1000 = 30_002,
	/**
	 * Maximum number of pins reached for the channel (50)
	 */
	MaximumNumberOfPinsReachedForTheChannel50 = 30_003,
	/**
	 * Maximum number of recipients reached (10)
	 */
	MaximumNumberOfRecipientsReached10 = 30_004,
	/**
	 * Maximum number of guild roles reached (250)
	 */
	MaximumNumberOfGuildRolesReached250 = 30_005,
	/**
	 * Maximum number of webhooks reached (15)
	 */
	MaximumNumberOfWebhooksReached15 = 30_007,
	/**
	 ...
	 */
	MaximumNumberOfReactionsReached20 = 30_010,
	/**
	 * Maximum number of group DMs reached (10)
	 */
	MaximumNumberOfGroupDMsReached10 = 30_011,
	/**
	 * Maximum number of guild channels reached (500)
	 */
	MaximumNumberOfGuildChannelsReached500 = 30_013,
	/**
	 * Maximum number of attachments in a message reached (10)
	 */
	MaximumNumberOfAttachmentsInAMessageReached10 = 30_015,
	/**
	 * Maximum number of invites reached (1000)
	 */
	MaximumNumberOfInvitesReached1000 = 30_016,
	/**
	 ...
	 */
	MaximumNumberOfServerCategoriesHasBeenReached5 = 30_030,
	/**
	 ...
	 */
	MaximumNumberOfThreadParticipantsHasBeenReached1000 = 30_033,
	/**
	 * Maximum number of daily application command creates has been reached (200)
	 */
	MaximumNumberOfDailyApplicationCommandCreatesHasBeenReached200 = 30_034,
	/**
	 ...
	 */
	MaximumNumberOfUncompletedGuildScheduledEventsReached100 = 30_038,
	/**
	 ...
	 */
	MaximumNumberOfPremiumEmojisReached25 = 30_056,
	/**
	 * Maximum number of webhooks per guild reached (1000)
	 */
	MaximumNumberOfWebhooksPerGuildReached1000 = 30_058,
	/**
	 * Maximum number of channel permission overwrites reached (1000)
	 */
	MaximumNumberOfChannelPermissionOverwritesReached1000 = 30_060,
	/**
...
/**
 * Zod schema for validating {@link JSONErrorCodes}.
 *
 * @example
 * JSONErrorCodesEnum.parse(JSONErrorCodes.GeneralError); // Valid
 * JSONErrorCodesEnum.parse(1001); // Throws an error
 */
...
/**
 * Zod schema for validating {@link RPCErrorCodes}.
 *
 * @example
 * RPCErrorCodesEnum.parse(RPCErrorCodes.UnknownError); // Valid
 * RPCErrorCodesEnum.parse(5005); // Throws an error
 */
...
/**
 * Zod schema for validating {@link RPCCloseCodes}.
 *
 * @example
 * RPCCloseCodesEnum.parse(RPCCloseCodes.InvalidClientID); // Valid
 * RPCCloseCodesEnum.parse(4006); // Throws an error
 */
