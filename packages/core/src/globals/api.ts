 ...
 * Image Base Url
 *
 * @description The base URL for all images.
 ...
 * Authentication
 *
 * @description Discord uses OAuth2 for providing authentication. OAuth2 is a protocol that lets external apps request authorization to private details in a user's Discord account without getting their password. This is preferred over traditional authentication for its security benefits.
 ...
 * Discord Epoch
 *
 * @description Discord uses a special epoch for our snowflake generation. This means that the timestamp is stored in the first 42 bits of the snowflake. This gives us a maximum timestamp of 2^42 or 4,398,046,511,104 or around 69 years. This gives us until 2080 to make sure we have a new solution.
 */
