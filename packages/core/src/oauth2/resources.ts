 ...
 * @see {@link https://discord.com/developers/docs/topics/oauth2#shared-resources}
 */
...
export enum OAuth2URLs {
	...
	TokenRevokeURL = "https://discord.com/api/oauth2/token/revoke",
...
export enum OAuth2Scopes {
	...
	RoleConnectionsWrite = "role.connections.write",
	Rpc = "rpc",
